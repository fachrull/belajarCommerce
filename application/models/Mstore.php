...
class Mstore extends CI_Model{
  ...
  public function order_list($idStore, $history = FALSE){
    ...
    public function getDetailOrder($idOrder, $idCustomer){
        $this->db->select('a.order_number, aa.quantity, a.id_userlogin, a.total, a.order_date, a.status_order, aa.id_tr_product, aa.subtotal, c.name, c.image, d.class, d.status,
