		...
		<div class="row mix-grid">
			...
			<div class="col-md-12 mb-30">
				...
				<div class="toggle toggle-transparent toggle-bordered-simple">
					...
					<div class="toggle mix design">
						<!-- toggle -->
						<label>1. Nulla lacinia iaculis nulla non pulvinar?</label>
						<div class="toggle-content">
							<p class="clearfix">
								<img class="hidden-sm float-left" src="<?= site_url('statis/agm-customer/assets/another-images/avatar2.jpg');?>" alt="Careers" />
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas metus nulla, commodo a sodales sed,
								dignissim pretium nunc. Nam et lacus neque. Ut enim massa, sodales tempor convallis et, iaculis ac massa.
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas metus nulla, commodo a sodales sed,
								dignissim pretium nunc. Nam et lacus neque. Ut enim massa, sodales tempor convallis et, iaculis ac massa.
								<br /><br />
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas metus nulla, commodo a sodales sed,
					...
					<div class="toggle mix photography">
						<!-- toggle -->
					...
					<div class="toggle mix development">
						<!-- toggle -->
						<label>4. Iaculis nulla non pulvinar?</label>
						<div class="toggle-content">
							<p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas metus nulla, commodo a
								sodales sed, dignissim pretium nunc. Nam et lacus neque.</p>
							<p class="clearfix">
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas metus nulla, commodo a sodales sed,
								dignissim pretium nunc. Nam et lacus neque. Ut enim massa, sodales tempor convallis et, iaculis ac massa.
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas metus nulla, commodo a sodales sed,
					...
					<div class="toggle mix development">
						...
						<div class="toggle-content">
							<p class="clearfix">
								<img class="hidden-sm float-left" src="demo_files/images/girl_looking-min_thumb.jpg" alt="Careers">
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas metus nulla, commodo a sodales sed,
								dignissim pretium nunc. Nam et lacus neque. Ut enim massa, sodales tempor convallis et, iaculis ac massa.
								Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas metus nulla, commodo a sodales sed,
								dignissim pretium nunc. Nam et lacus neque. Ut enim massa, sodales tempor convallis et, iaculis ac massa.
...
<a href="#purchase" rel="nofollow" target="_blank" class="btn btn-xlg btn-footer fs-2 fullwidth m-0 rad-0 p-40">
	<span class="font-lato fs-30">
		...
		<br>
		<strong class="fs-20">Let us know what you need, we'll try to help &raquo;</strong>
	</span>
</a>
<!-- /BUTTON CALLOUT -->
