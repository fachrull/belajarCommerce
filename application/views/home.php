        ...
        if ($i % 2 == 1) { ?>
            <div class="row">
                <div class="col-12 col-md-5 pb-5">
                    <div class="buttons-autohide controlls-over mb-30"
                         data-plugin-options='{"singleItem": true, "navigation": false, "autoPlay": 3000, "pagination": false, "transitionStyle":"fade"}'>
                        <div>
                            <img class="pedia-img-1" src="<?= base_url('asset/content-images/slider-1.jpg'); ?>"
                                 style="width:100%;" alt="agmpedia title">
                            <div class="absolute pt-30">
                                ...
                                <p class="text-center to-center fs-13 pt-10">
                                    <a class="text-white block"
                                       href="<?= site_url('home/fullArticle/'.$pedia['id']); ?>">read more<i
                                                class="fa fa-chevron-right pl-5"
                ...
                <div class="col-12 col-md-7 pb-5">
                    <div class="buttons-autohide controlls-over mb-30"
                         data-plugin-options='{"singleItem": true, "navigation": false, "autoPlay": 3000, "pagination": false, "transitionStyle":"fade"}'>
                        <img class="pedia-img-1" src="<?= base_url('asset/upload/pedia/'.$pedia['thumbnail']); ?>"
                             alt="agmpedia">
                    </div>
                </div>
            </div>
                    ...
                    <div class="buttons-autohide controlls-over mb-30"
                        ...
                        <div>
                            ...
                            <div class="absolute pt-20">
                                ...
                                <p class="text-center to-center fs-13 pt-10">
                                    <a class="text-white" href="<?= site_url('home/fullArticle/'.$pedia['id']); ?>">read
                                        more<i class="fa fa-chevron-right pl-5"
