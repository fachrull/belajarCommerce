          ...
          <div class="box-body">
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                <li class="active"><a href="#table" data-toggle="tab">List Bed Linen</a></li>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="addcover">
                  <?php if($slides == NULL): ?>
                    ...
                    <?php endif; ?>
                    <form class="m-0 sky-form" action="<?= site_url('admin/bed_linen');?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                      <p class="register-box-msg">Add a new cover</p>
                      <label class="input mb-10">
                        <input type="file" name="cover_bedLinen" />
                      </label>
                      <div class="row">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="thumbnail" style="padding:14px 14px 0px 14px">
                          <img src="<?= base_url('asset/upload/bed-linen-cover/'.$slides['slide']);?>"><br>
                        </div>
                        <div>
                          <a href="<?= site_url('admin/delete_cover_bedLinen/'.$slides['id']);?>" onclick="return confirm('Are you sure?')"><i class="btn btn-danger fa fa-trash pull-right fa fa-trash"></i></a>
                        </div>
                      </div>
                    </div>
                  <?php endif; ?>
