...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2019 at 05:56 AM
...
(1, 0x312e6a7067, '2019-03-26 00:00:00', '0000-00-00 00:00:00', '1'),
(2, 0x626573742d73656c6c65722d636f7665722d356339613461623439653836652e6a7067, '2019-03-26 00:00:00', '0000-00-00 00:00:00', '2'),
(6, 0x7370656369616c2d7061636b6167652d636f7665722d356339613539353434633666362e6a7067, '2019-03-26 00:00:00', '0000-00-00 00:00:00', '3'),
(7, 0x6265642d6c696e656e2d636f7665722d356339613930393337623438322e6a7067, '2019-03-26 00:00:00', '0000-00-00 00:00:00', '4'),
(8, 0x62656464696e672d6163636573736f726965732d636f7665722d356339613934633761323632392e6a7067, '2019-03-26 00:00:00', '0000-00-00 00:00:00', '5');
...
(3, 40, 'Fachrul', 'Fandi Wiradhika', 'm', 'fachrul@email.com', '085712345678', 'Jl. Tidak Sesama No. 321', '31', '3174', '317403', '12780', 1),
...
(15, 15, 'Fachrul', 'Fandi', '', 'fachrulpaul@gmail.com', '08571234567', 'Jl. Sesama No. 123', '31', '3173', '317301', '123456', 0),
(16, 15, 'Fachrul', 'Fandi', '', 'fachrulpaul@gmail.com', '0857123456', 'Jl. Sesama No. 123', '31', '3173', '317301', '123456', 0),
(17, 15, 'Fachrul', 'Fandi', '', 'fachrulpaul@gmail.com', '0857123456', 'Jl. Sesama No.123', '31', '3173', '317301', '123456', 0),
(18, 40, 'Fachrul', 'Fandi', '', 'fachrulpaul@gmail.com', '0857123456', 'Jl. Sesama No. 123', '31', '3173', '317301', '123456', 0);
...
CREATE TABLE IF NOT EXISTS `tm_product` (
  ...
  `active` int(11) DEFAULT '1' COMMENT 'active = 1; inactive = 0',
...
(1, 'Single', '97 cm × 191 cm', '2019-01-14 17:00:00', '2019-01-15 10:38:15', 1),
(2, 'Twin', '135 cm × 191 cm', '2019-01-14 17:00:00', '2019-01-15 10:38:35', 1),
...
(5, 'Super king', '183 cm × 213 cm', '2019-01-14 17:00:00', '2019-01-15 10:39:35', 1),
(6, 'Kid', '100cm × 100 cm', '2019-04-09 13:54:01', '2019-04-09 13:54:01', 1),
(7, 'PCS', '-', '2019-04-09 13:54:01', '2019-04-09 13:54:01', 1),
(8, 'PKG', '-', '2019-04-09 13:54:10', '2019-04-09 13:54:10', 1);
...
(0, 0x626573742d73656c6c65722d636f7665722d356339613436396132653865382e6a7067, '2019-03-25 17:00:00', '2019-03-26 15:34:50', '2'),
(0, 0x312e6a7067, '2019-03-25 17:00:00', '2019-03-26 15:45:24', '');
...
(4, 43, 'AGM Fatmawati', 'Jl. RS Fatmawati  No. 22', '', '317406', '3174', '31', -6.273532, 106.797563, '12420', '02175913355', '', 2),
(5, 44, 'AGM Kemang', 'Jl. Kemang Raya No. 8 (Ex Gedung La Codefin)', '', '317406', '3174', '31', -6.255665, 106.813879, '12730', '0217180267', '', 2),
(6, 45, 'agm garry', 'Jl. Sesama No. 123', '', '317509', '3175', '31', 0, 0, '13739', '08123456789', '', 2);
...
(9, 1, 30, 46, 1000, 0, 2),
(10, 1, 30, 45, 1000, 0, 2),
(11, 1, 136, 253, 1000, 0, 2),
(12, 1, 96, 182, 10000, 1, 2),
(13, 1, 96, 183, 10000, 1, 2),
(14, 1, 16, 17, 1000, 1, 2),
(15, 1, 16, 18, 1000, 1, 2),
(16, 1, 21, 27, 1000, 1, 2);
...
INSERT INTO `tr_product_bedding_acc` (`id`, `prod_id`, `position`) VALUES
(1, 21, 1),
(2, 22, 2),
(3, 23, 3),
(4, 25, 4),
...
INSERT INTO `tr_product_bed_linen` (`id`, `prod_id`, `position`) VALUES
(4, 16, 1),
(5, 17, 2),
(6, 18, 3),
(7, 19, 4),
...
INSERT INTO `tr_product_best_seller` (`id`, `prod_id`, `position`) VALUES
(1, 96, 2),
(2, 27, 4),
(3, 39, 3),
(4, 59, 1);
...
INSERT INTO `tr_product_size` (`id`, `sku`, `prod_id`, `size_id`, `price`) VALUES
(1, '', 1, 4, '1000000'),
(2, '', 2, 3, '1000000'),
(3, '', 3, 5, '1000000'),
(4, '', 4, 2, '1000000'),
...
(244, '', 127, 2, '1000'),
(247, '', 129, 1, '1000000'),
(248, 'SKU12334', 130, 1, '1000000'),
(249, 'SKU12334', 130, 1, '1000000'),
(250, 'SKU12234', 133, 1, '1000000'),
(251, 'SKU123344', 133, 2, '2000000'),
(253, 'SKUPKG', 136, 8, '105000000'),
(261, 'SKU55442', 143, 4, '100000000'),
(262, 'SKU55443', 143, 2, '75000000'),
(263, 'SKU00122', 144, 1, '10000000'),
(264, 'SKU00123', 144, 3, '15000000'),
(265, 'SKU00111', 145, 3, '50000000'),
(266, 'SKU00112', 145, 5, '55000000'),
(267, 'SKU1233', 146, 3, '10000000'),
(268, 'SKU12222', 147, 3, '15000000'),
(269, 'SKU13333', 148, 3, '20000000');
...
CREATE TABLE IF NOT EXISTS `tr_special_package` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_prod_spclPkg` int(11) NOT NULL,
  `size_spclPkg` int(11) NOT NULL,
  `quantity` int(11) NOT NULL,
  `priceSpcl` varchar(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_prod_spclPkg` (`id_prod_spclPkg`),
  KEY `size_spclPkg` (`size_spclPkg`)
...
INSERT INTO `tr_special_package` (`id`, `id_prod_spclPkg`, `size_spclPkg`, `quantity`, `priceSpcl`) VALUES
(12, 136, 1, 1, '100000000'),
(13, 136, 34, 2, '5000000');
...
(42, 'fandi', '$2y$10$6V2MUH9XSMtg5GJdaAmvSOswyMrf3PPPSeiOwZBY6H2wGvAQml6k6', 'fandi@email.com', 4, 0, NULL),
(43, 'agmFatmawati', '$2y$10$TIek25oPdN4G/lH6BQu2Ye.sx.Ex1L6H4R.zdA8oDMB2OGFBQGlfi', 'agm.fatmawati@email.com', 3, 0, 2),
(44, 'agmKemang', '$2y$10$haKvEUTUgUejR/TiBkq3OOKgi9bOF0b6qJqdqFX5zvjcqt94ykb4y', 'agm.kemang@email.com', 3, 0, 2),
(45, 'agmgarry', '$2y$10$yk16ixGkX/WUh.zdueJdE.78TkxLNmZAnmtsFAHnzAiXgJyhlTd9K', 'agm.garry@email.com', 3, 1, 2);
...
ALTER TABLE `tr_special_package`
  ADD CONSTRAINT `tr_special_package_ibfk_1` FOREIGN KEY (`id_prod_spclPkg`) REFERENCES `tm_product` (`id`),
  ADD CONSTRAINT `tr_special_package_ibfk_2` FOREIGN KEY (`size_spclPkg`) REFERENCES `tr_product_size` (`id`);
