...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2019 at 12:18 PM
...
(130, 1, 2, 'Test bedlinen product', '<p>Description of&nbsp;Test bedlinen product</p>\r\n', 0x616972656c6f6f6d2d6265645f6c696e656e2d746573745f6265646c696e656e5f70726f647563742e6a7067, '2019-04-07 17:00:00', '2019-04-08 07:17:11');
...
CREATE TABLE IF NOT EXISTS `tr_special_package` (
  ...
  KEY `id_tr_prod_size` (`id_tr_prod_size`)
...
ALTER TABLE `tr_special_package`
  ...
  ADD CONSTRAINT `tr_special_package_ibfk_2` FOREIGN KEY (`id_tr_prod_size`) REFERENCES `tr_product_size` (`id`);
